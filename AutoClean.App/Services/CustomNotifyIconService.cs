...
namespace AutoClean.App.Services;
...
public class CustomNotifyIconService : NotifyIconService
{
    public CustomNotifyIconService()
    {
        ...
        Icon = BitmapFrame.Create(new Uri("pack://application:,,,/Resources/favicon.png", UriKind.Absolute));
    ...
    {
        System.Diagnostics.Debug.WriteLine($"DEBUG | WPF UI Tray event: {nameof(OnLeftClick)}", "AutoClean.App");
    }
    ...
    private void OnMenuItemClick(object sender, RoutedEventArgs e)
    {
        ...
        System.Diagnostics.Debug.WriteLine($"DEBUG | WPF UI Tray clicked: {menuItem.Tag}", "AutoClean.App");
    }
}
