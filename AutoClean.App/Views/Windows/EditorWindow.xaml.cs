...
namespace AutoClean.App.Views.Windows
{
    ...
    public partial class EditorWindow : Wpf.Ui.Controls.UiWindow
    {
...
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Clicked: " + tag, "AutoClean.App");
#endif
        ...
        private void UpdateLine()
        {
            ...
            RootTextBox.CaretPosition.GetLineStartPosition(-int.MaxValue, out int lineMoved);
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor got focus", "AutoClean.App.Editor");
#endif
            UpdateLine();
        }
        ...
        private void RootTextBox_OnPreviewMouseDown(object sender, MouseButtonEventArgs e)
        {
            if (e.ClickCount > 2)
                return;
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor mouse down", "AutoClean.App.Editor");
#endif
            UpdateLine();
        }
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor key up", "AutoClean.App.Editor");
#endif
            UpdateLine();
        }
